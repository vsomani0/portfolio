...
createBrushSelector(d3.select("#scatter-plot > svg"));
...
onTimeSliderChange();
console.log(commits);
commits = commits.sort((c1, c2) => c1.datetime - c2.datetime);
  ...
  .html(
    (d, i) => `
      ...
      d3.rollups(
		...
		Then I looked over all I had made, and I liked it quite a bit.
	`
  );
